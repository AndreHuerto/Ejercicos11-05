...
do {
    ...
    console.log(numero);
    agregar();
    resp = prompt("¿Quiere ingresar otro número?");
...
function operaciones(){
    ...
    alert("La suma de los numeros es: "+S1);
    alert("La suma de los numeros negativos es: "+S2);
    alert("La suma de de los numeros PARES es: "+S3);
    alert("La suma de los numeros IMPARES es: "+S4);
